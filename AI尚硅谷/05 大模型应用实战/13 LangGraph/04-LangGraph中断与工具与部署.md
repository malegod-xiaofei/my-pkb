...
![image-20260616144341319](images/image-20260616144341319.png)
...
![image-20260616144631814](images/image-20260616144631814.png)
...
![image-20260616144742361](images/image-20260616144742361.png)
...
![image-20260616144804813](images/image-20260616144804813.png)
...
![image-20260616145202853](images/image-20260616145202853.png)
...
![image-20260617175548170](images/image-20260617175548170.png)
...
![image-20260617180203915](images/image-20260617180203915.png)
...
![image-20260618112859465](images/image-20260618112859465.png)
...
![image-20260618113316239](images/image-20260618113316239.png)
...
![image-20260618113535376](images/image-20260618113535376.png)
...
![image-20260618155610059](images/image-20260618155610059.png)
...
![image-20260618145109521](images/image-20260618145109521.png)
...
![image-20260618145350749](images/image-20260618145350749.png)
...
![image-20260618150027247](images/image-20260618150027247.png)

#### 9.1.4.2. 第一次恢复运行

计算图触发第一个断点，只需要输入本地开发时传递给 **`Command(resume)`** 的值即可

![image-20260618150257805](images/image-20260618150257805.png)

#### 9.1.4.3. 第二次恢复运行

输入年龄

![image-20260618150507901](images/image-20260618150507901.png)

#### 9.1.4.4. 第三次恢复运行

输入性别

![image-20260618150603796](images/image-20260618150603796.png)

#### 9.1.4.5. 最终结果

![image-20260618150618027](images/image-20260618150618027.png)

### 9.1.5. 调试时添加静态断点

我们可以在调试时添加静态断点

![image-20260622094203428](images/image-20260622094203428.png)

我们在 **`get_info_node`** 之前添加断点

![image-20260622094313578](images/image-20260622094313578.png)

运行

![image-20260622094329281](images/image-20260622094329281.png)

中断后继续

![image-20260622094437681](images/image-20260622094437681.png)

开始执行正常的节点计算逻辑

![image-20260622094515519](images/image-20260622094515519.png)
...
![image-20260618162305375](images/image-20260618162305375.png)
...
![image-20260618162323141](images/image-20260618162323141.png)

### 9.2.3. 测试

#### 9.2.3.1. 对话

![image-20260618162337948](images/image-20260618162337948.png)

#### 9.2.3.2. 工具调用

在工具节点添加了 **`HITL`** 机制，所以调用工具会触发中断

![image-20260618162433292](images/image-20260618162433292.png)

##### 9.2.3.2.1. 同意调用

点击 **`Approve`** 按钮

![image-20260618162626628](images/image-20260618162626628.png)

**结果如下**

![image-20260618162813994](images/image-20260618162813994.png)

##### 9.2.3.2.2. 修改参数后调用

![image-20260618162911108](images/image-20260618162911108.png)

**修改后提交，结果如下**

![image-20260618163010522](images/image-20260618163010522.png)

##### 9.2.3.2.3. 拒绝调用

![image-20260618163130038](images/image-20260618163130038.png)

**编辑原因后拒绝，结果如下**

![image-20260618163143688](images/image-20260618163143688.png)

#### 9.2.3.3. 查看历史记录

![image-20260618163230394](images/image-20260618163230394.png)

左侧列出了历史会话，点击会话名称即可查看历史会话

![image-20260618163307768](images/image-20260618163307768.png)

如果配置了 **`LangSmith`** 追踪所需的环境变量，还可以在以下页面追踪调用的详细信息。

![image-20260618162754391](images/image-20260618162754391.png)
...
![image-20260622095910802](images/image-20260622095910802.png)
...
![image-20260622100605743](images/image-20260622100605743.png)
...
![image-20260622104243639](images/image-20260622104243639.png)
...
![image-20260622105919179](images/image-20260622105919179.png)
...
![image-20260622112113218](images/image-20260622112113218.png)
