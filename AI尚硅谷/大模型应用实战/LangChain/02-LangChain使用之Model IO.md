...
![[Pasted image 20260507155753.png]]
...
- **输出**：总是返回文本字符串
![[Pasted image 20260507162950.png]]
...
![[Pasted image 20260507163050.png]]
...
![[Pasted image 20260507163107.png]]
...
**方式2：从 PyCharm 设置**
![[Pasted image 20260507163555.png]]![[Pasted image 20260507163600.png]]
**举例：**
```python
import os
from langchain_openai import ChatOpenAI
...
![[Pasted image 20260507164636.png]]
**对应的配置文件：**
```
...
![[Pasted image 20260507164652.png]]
**举例1：通过 OpenAI SDK：**
```python
from openai import OpenAI
import os
...
![[Pasted image 20260507164836.png]]
![[Pasted image 20260507164842.png]]
**配置文件：**
```
ZHIPUAI_API_KEY="63a0f275b3a9###############rA4Y8daGaLydxQ"
```
**查看《开发文档》**
![[Pasted image 20260507164859.png|596]]
![[Pasted image 20260507164931.png]]
或者选择如下《参考文档》皆可：
[https://www.bigmodel.cn/dev/api/normal-model/glm-4](https://www.bigmodel.cn/dev/api/normal-model/glm-4)
![[Pasted image 20260507164958.png]]
**举例1：使用 OpenAI SDK：**
```python
from openai import OpenAI
import os
...
**申请API Key：**
![[Pasted image 20260507165149.png|596]]
...
**或者：**
![[Pasted image 20260507165232.png]]
![[Pasted image 20260507165236.png]]
...
![[Pasted image 20260507165841.png]]
