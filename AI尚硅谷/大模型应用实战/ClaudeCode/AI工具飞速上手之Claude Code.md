...
```plain
ANTHROPIC_API_KEY
sk-iIxiYnQdWgGgylHY7Slg4LF2F12NfS940ZLTlpayEeRq8LI9
```
```plain
ANTHROPIC_BASE_URL
...
#### 2.3.2 安装Git
+ 下载网址 [https://git-scm.com/downloads](https://git-scm.com/downloads)
...
![图片](images/图片11.png)
#### 2.3.3  安装 Node.js
下载网址：[https://nodejs.org/zh-tw/download/current](https://nodejs.org/zh-tw/download/current)
