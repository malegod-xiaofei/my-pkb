...
publicFSDataOutputStream create(Path f, booleanoverwrite)
...
- Ctrl + h查找create实现类，点击NameNodeRpcServer，在NameNodeRpcServer.java中搜索create
NameNodeRpcServer.java
...
- CentOS虚拟机准备
  - CentOS联网
配置CentOS能连接外网。Linux虚拟机ping  是畅通的
