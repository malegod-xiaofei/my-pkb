### 学习目标[¶](http://127.0.0.1:5500/4.html#_1)
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730540611203-ebd5bb4c-2c07-4bc8-802f-e865434e5a9a.png)

---

### 相关知识[¶](http://127.0.0.1:5500/4.html#_2)
+ 模型压缩:
...
### 数据集说明[¶](http://127.0.0.1:5500/4.html#_3)
+ GLUE数据集合的介绍：
...
### 使用huggingface中的预训练BERT模型进行微调[¶](http://127.0.0.1:5500/4.html#huggingfacebert)
+ 第一步: 安装必要的工具包并导入
+ 第二步: 下载数据集并使用脚本进行微调
+ 第三步: 设定全局配置并加载微调模型
+ 第四步: 编写用于模型使用的评估函数
...
#### 第一步: 安装核心的工具包并导入[¶](http://127.0.0.1:5500/4.html#_4)
+ 安装核心工具包:
...
#### 第二步: 下载数据集并使用脚本进行微调[¶](http://127.0.0.1:5500/4.html#_5)
+ 下载GLUE中的MRPC数据集:
...
#### 第三步: 设定全局配置并加载微调模型[¶](http://127.0.0.1:5500/4.html#_6)
+ 设定全局配置:
...
### 使用动态量化技术对训练后的bert模型进行压缩[¶](http://127.0.0.1:5500/4.html#bert)
+ 第一步: 将模型应用动态量化技术
+ 第二步: 对比压缩后模型的大小
...
#### 第一步: 将模型应用动态量化技术[¶](http://127.0.0.1:5500/4.html#_7)
+ 应用动态量化技术:
...
#### 第二步: 对比压缩后模型的大小[¶](http://127.0.0.1:5500/4.html#_8)
```plain
...
#### 第三步: 对比压缩后的模型的推理准确性和耗时[¶](http://127.0.0.1:5500/4.html#_9)
```plain
...
#### 第四步: 序列化模型以便之后使用[¶](http://127.0.0.1:5500/4.html#_10)
```plain
# 量化模型的保存路径
...
### 附录[¶](http://127.0.0.1:5500/4.html#_11)
#### run_glue.py微调脚本代码[¶](http://127.0.0.1:5500/4.html#run_gluepy)
...
> 来自: [应用于bert模型的动态量化技术 - NLP案例集](http://127.0.0.1:5500/4.html)
>
