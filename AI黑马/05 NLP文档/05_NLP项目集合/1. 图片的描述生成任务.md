## 图片的描述生成任务
### 学习目标[¶](http://127.0.0.1:5500/1.html#_1)
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730540579291-67c0c065-9c9a-44ec-8491-cda76c4d1c6f.png)

---

### 任务说明[¶](http://127.0.0.1:5500/1.html#_2)
...
### 数据集说明[¶](http://127.0.0.1:5500/1.html#_3)
+ 数据集名称: MS-COCO
...
### 使用迁移学习实现图片的描述生成过程[¶](http://127.0.0.1:5500/1.html#_4)
...
#### 第一步: 导入必备的工具包并下载MS-COCO数据集[¶](http://127.0.0.1:5500/1.html#ms-coco)
```plain
...
#### 第二步: 限制训练集的大小以保证在可控时间内完成训练[¶](http://127.0.0.1:5500/1.html#_5)
+ 限制训练集大小的目标:
...
#### 第三步: 使用InceptionV3预训练模型处理图片训练集数据[¶](http://127.0.0.1:5500/1.html#inceptionv3)
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/jpeg/25755350/1730540578999-892f0b39-69e6-4c93-8934-966baed5102a.jpeg)
...
#### 第四步: 对图片描述的文本进行处理[¶](http://127.0.0.1:5500/1.html#_6)
...
#### 第五步: 划分训练与验证数据集并使用tf.data封装[¶](http://127.0.0.1:5500/1.html#tfdata)
+ 划分训练与验证数据集:
...
#### 第六步: 构建微调模型并选取优化方法和损失函数[¶](http://127.0.0.1:5500/1.html#_7)
+ 构建注意力机制的类:
    - 注意力机制的计算规则遵循以下公式:

<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/jpeg/25755350/1730540579069-99af8127-2000-488b-b1fc-a93efdcae2cc.jpeg)

<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/jpeg/25755350/1730540579015-b829ef5f-d8ce-448d-8782-7cecb68946a2.jpeg)
...
#### 第七步: 构建训练函数并进行训练[¶](http://127.0.0.1:5500/1.html#_8)
+ 构建训练函数:
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730540579027-78f1b611-1367-4ea1-9b46-825f065b0f54.png)

---

#### 第八步: 构建评估函数并进行评估[¶](http://127.0.0.1:5500/1.html#_9)
+ 构建评估函数:
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730540579374-51058de9-e58f-45f0-ad51-1546f6256db5.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730540579939-2c28ffa1-88bd-4ba3-a8fa-8658ad796f00.png)
...
> 来自: [图片的描述生成任务 - NLP案例集](http://127.0.0.1:5500/1.html)
>
