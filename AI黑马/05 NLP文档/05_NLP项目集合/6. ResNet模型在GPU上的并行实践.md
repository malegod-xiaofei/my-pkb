### 学习目标[¶](http://127.0.0.1:5500/6.html#_1)
+ 了解模型并行与数据并行的区别.
+ 了解分布式训练与并行训练的关系.
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730540629968-557fc3c0-41ad-4a8d-8c63-e2c30c3cf977.png)

---

### 相关知识[¶](http://127.0.0.1:5500/6.html#_2)
+ 并行/分布训练及其两者的关系：
...
### 单机多GPU的模型并行[¶](http://127.0.0.1:5500/6.html#gpu)
...
#### 第一步: 查看硬件配置并以一个简单示例理解模型分配[¶](http://127.0.0.1:5500/6.html#_3)
+ 查看硬件配置
...
#### 第二步: 将大型模型ResNet50结构分配到多个GPU上[¶](http://127.0.0.1:5500/6.html#resnet50gpu)
```plain
...
#### 第三步: 对比模型多GPU并行和单GPU的耗时[¶](http://127.0.0.1:5500/6.html#gpugpu)
+ 绘制模型双GPU并行和单GPU的耗时图
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730540629971-d3d4d2a7-3e93-49cc-97d8-4fdbeedae92c.png)
...
#### 第四步: 使用流水线技术加速多GPU训练[¶](http://127.0.0.1:5500/6.html#gpu_1)
+ 模型训练的流水线技术:
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730540629983-c6ef3eb0-ed34-4a62-a618-2fccfd877dc4.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730540629980-b46c554e-1186-4e32-b38a-fb4f8e047e77.png)
...
> 来自: [ResNet模型在GPU上的并行实践 - NLP案例集](http://127.0.0.1:5500/6.html)
>
