### 学习目标[¶](http://121.199.45.168:8008/6/#_1)
+ 了解模型并行与数据并行的区别.
+ 了解分布式训练与并行训练的关系.
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730543635953-6231e3c8-489e-408c-8922-de6debe301af.png)

---

### 相关知识[¶](http://121.199.45.168:8008/6/#_2)
+ 并行/分布训练及其两者的关系：
...
### 单机多GPU的模型并行[¶](http://121.199.45.168:8008/6/#gpu)
...
#### 第一步: 查看硬件配置并以一个简单示例理解模型分配[¶](http://121.199.45.168:8008/6/#_3)
+ 查看硬件配置
...
#### 第二步: 将大型模型ResNet50结构分配到多个GPU上[¶](http://121.199.45.168:8008/6/#resnet50gpu)
```plain
...
#### 第三步: 对比模型多GPU并行和单GPU的耗时[¶](http://121.199.45.168:8008/6/#gpugpu)
+ 绘制模型双GPU并行和单GPU的耗时图
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730543635970-1cb92b16-83f0-4a25-b0a6-8db1b12dd371.png)
...
#### 第四步: 使用流水线技术加速多GPU训练[¶](http://121.199.45.168:8008/6/#gpu_1)
+ 模型训练的流水线技术:
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730543635976-265a2d23-c0d6-45bd-9568-519c55af98ec.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730543635970-017c8996-4731-4069-8a68-a4a97e30774f.png)
...
> 来自: [ResNet模型在GPU上的并行实践 - NLP案例集](http://127.0.0.1:5500/ResNet%E6%A8%A1%E5%9E%8B%E5%9C%A8GPU%E4%B8%8A%E7%9A%84%E5%B9%B6%E8%A1%8C%E5%AE%9E%E8%B7%B5%20-%20NLP%E6%A1%88%E4%BE%8B%E9%9B%86.html)
>
