## 图片的描述生成任务
### 学习目标[¶](http://121.199.45.168:8008/1/#_1)
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730543553729-b727eae8-0eb5-483b-b93b-1f58762adbb1.png)

---

### 任务说明[¶](http://121.199.45.168:8008/1/#_2)
...
### 数据集说明[¶](http://121.199.45.168:8008/1/#_3)
+ 数据集名称: MS-COCO
+ 数据下载地址: [http://cocodataset.org/#download](http://cocodataset.org/#download)
+ 数据文件分为两部分:
...
### 使用迁移学习实现图片的描述生成过程[¶](http://121.199.45.168:8008/1/#_4)
...
#### 第一步: 导入必备的工具包并下载MS-COCO数据集[¶](http://121.199.45.168:8008/1/#ms-coco)
```plain
...
> + 下载后的文件详情请参考[2.1 使用迁移学习进行图片的描述生成任务](http://47.92.175.143:8008/1/#21)下的相关数据集.
>

---

#### 第二步: 限制训练集的大小以保证在可控时间内完成训练[¶](http://121.199.45.168:8008/1/#_5)
+ 限制训练集大小的目标:
...
#### 第三步: 使用InceptionV3预训练模型处理图片训练集数据[¶](http://121.199.45.168:8008/1/#inceptionv3)
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/jpeg/25755350/1730543553175-3a2f14bc-46a0-479f-9fa3-e67236d2da70.jpeg)
...
#### 第四步: 对图片描述的文本进行处理[¶](http://121.199.45.168:8008/1/#_6)
...
#### 第五步: 划分训练与验证数据集并使用tf.data封装[¶](http://121.199.45.168:8008/1/#tfdata)
+ 划分训练与验证数据集:
...
#### 第六步: 构建微调模型并选取优化方法和损失函数[¶](http://121.199.45.168:8008/1/#_7)
+ 构建注意力机制的类:
    - 注意力机制的计算规则遵循以下公式:

<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/jpeg/25755350/1730543553437-237b5bc2-861c-4bd3-9502-9768294ae46f.jpeg)

<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/jpeg/25755350/1730543553172-11ec92b5-d5c0-43ed-9697-d4b3f0ca080b.jpeg)
...
#### 第七步: 构建训练函数并进行训练[¶](http://121.199.45.168:8008/1/#_8)
+ 构建训练函数:
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730543553322-870a0578-1107-4fc8-8f40-0ea8c4096309.png)

---

#### 第八步: 构建评估函数并进行评估[¶](http://121.199.45.168:8008/1/#_9)
+ 构建评估函数:
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730543553510-9bddcd53-5c04-454a-ae4a-fb0500f958ac.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730543554048-1dd95609-3c1a-42de-95bf-ebc3781a886e.png)
...
> 来自: [图片的描述生成任务 - NLP案例集](http://127.0.0.1:5500/%E5%9B%BE%E7%89%87%E7%9A%84%E6%8F%8F%E8%BF%B0%E7%94%9F%E6%88%90%E4%BB%BB%E5%8A%A1%20-%20NLP%E6%A1%88%E4%BE%8B%E9%9B%86.html)
>
