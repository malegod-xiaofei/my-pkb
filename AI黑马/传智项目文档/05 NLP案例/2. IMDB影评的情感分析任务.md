### 学习目标[¶](http://121.199.45.168:8008/2/#_1)
+ 了解影评情感分析任务和IMDB数据集。
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730543569123-afd8bc6c-92d0-4e65-8da3-c0984da3a541.png)

---

### 任务说明[¶](http://121.199.45.168:8008/2/#_2)
+ 对IMDB影评语料进行情感分析，是NLP中典型的应用案例，它的输入是一段文本，输出该段文本为“积极”或“消极”的态度，这是典型的二分类任务。与此同时，我还将在此任务基础上对所使用的RNN模型进行改进，增加更多的隐层来比较最终的效果！

---

### 数据集说明[¶](http://121.199.45.168:8008/2/#_3)
+ 数据集名称: IMDB数据集
+ 数据集大小: 84M
+ 数据下载地址: [http://ai.stanford.edu/~amaas/data/sentiment/](http://ai.stanford.edu/~amaas/data/sentiment/)
+ 训练样本数: 25000
+ 验证样本数: 25000
+ 数据集预览: 
...
### 使用GRU模型实现文本生成任务的步骤[¶](http://121.199.45.168:8008/2/#gru)
...
#### 第一步: 使用TFDS下载IMDB数据集，并划分训练集和测试集[¶](http://121.199.45.168:8008/2/#tfdsimdb)
+ 下载IMDB数据:
...
#### 第二步：按batch划分数据并训练单层biLSTM模型[¶](http://121.199.45.168:8008/2/#batchbilstm)
+ 批次化数据
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730543568951-313e600d-ccfb-4cb2-b72f-3ef0a8919427.png)

<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730543568968-b03a658b-6a73-490a-9a1c-841e23fc1aae.png)
...
#### 第三步：训练双层bi-LSTM模型，对比效果[¶](http://121.199.45.168:8008/2/#bi-lstm)
+ 构建模型
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730543568968-0c55eb1f-ab1a-4b9f-9499-0b6a7c24a61f.png)

<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730543568977-6d060a7e-c629-4ad6-82ad-f9978a62859d.png)
...
> 来自: [IMDB影评的情感分析任务 - NLP案例集](http://127.0.0.1:5500/IMDB%E5%BD%B1%E8%AF%84%E7%9A%84%E6%83%85%E6%84%9F%E5%88%86%E6%9E%90%E4%BB%BB%E5%8A%A1%20-%20NLP%E6%A1%88%E4%BE%8B%E9%9B%86.html)
>
