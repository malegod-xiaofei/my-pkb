## 莎士比亚风格的文本生成任务
### 学习目标[¶](http://121.199.45.168:8008/3/#_1)
+ 了解文本生成任务和相关数据集.
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730543584043-c2f53028-8cd4-460a-a85b-7510447c8ac6.png)

---

### 任务说明[¶](http://121.199.45.168:8008/3/#_2)
...
### 数据集说明[¶](http://121.199.45.168:8008/3/#_3)
+ 数据集名称: 莎士比亚作品数据集
+ 数据下载地址: [https://storage.googleapis.com/download.tensorflow.org/data/shakespeare.txt](https://storage.googleapis.com/download.tensorflow.org/data/shakespeare.txt)
+ 数据集预览:
...
### 使用GRU模型实现文本生成任务的步骤[¶](http://121.199.45.168:8008/3/#gru)
+ 第一步: 下载数据集并做文本预处理
+ 第二步: 构建模型并训练模型
+ 第三步: 使用模型生成文本内容
...
#### 第一步: 下载数据集并做文本预处理[¶](http://121.199.45.168:8008/3/#_4)
+ 下载数据:
...
#### 第二步: 构建模型并训练模型[¶](http://121.199.45.168:8008/3/#_5)
```plain
# 获得词汇集大小
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730543583963-1bc9d22c-368d-477b-8327-97b7651f6b1b.png)
...
#### 第三步: 使用模型生成文本内容[¶](http://121.199.45.168:8008/3/#_6)
+ 恢复模型:
...
### 更高级的方式[¶](http://121.199.45.168:8008/3/#_7)
```plain
...
> 来自: [莎士比亚风格的文本生成任务 - NLP案例集](http://127.0.0.1:5500/%E8%8E%8E%E5%A3%AB%E6%AF%94%E4%BA%9A%E9%A3%8E%E6%A0%BC%E7%9A%84%E6%96%87%E6%9C%AC%E7%94%9F%E6%88%90%E4%BB%BB%E5%8A%A1%20-%20NLP%E6%A1%88%E4%BE%8B%E9%9B%86.html)
>
