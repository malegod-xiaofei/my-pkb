...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730545245192-0e3c3e97-9b7f-4e03-9b52-8d408bdcc5b7.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730545244976-e548c138-7873-4ff6-aae7-562458d1a8fc.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730545244985-65b44d10-ae36-4837-ba81-ed6f80d1e4e4.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730545244997-e51372c3-46e0-4bec-be95-637311f3e2f3.png)
...
+ 二分类交叉熵损失:
    ...
    - 形式： <!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730545244994-2254643e-3836-49ac-b122-f69bbd216f78.png)
...
---
    ...
    - 二分类交叉熵损失:
        * 作用: 用于描述模型预测值与真实值的差距大小.
        * 形式: <!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730545245249-28cf7f17-8ccc-4004-9ff6-cc8c67a6808e.png)
        * 优势: 作为一种优化后的损失函数，能够避免均方误差损失的在处理sigmoid函数时收敛到趋于1时，梯度非常平缓，又因为使用的优化方法往往基于梯度下降，所以出现”学习迟缓”的现象.为了避免该现象，交叉熵的形式应运而生。
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730545245253-af3e323d-0a3a-4502-b255-4c0010897857.png)
...
<!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730545245265-3903f8eb-8c44-4760-830f-8d2ff26f8262.png)
...
---
    ...
    - 二分类交叉熵损失:
        * 作用: 用于描述模型预测值与真实值的差距大小.
        * 形式: <!-- 这是一张图片，ocr 内容为： -->
![](https://cdn.nlark.com/yuque/0/2024/png/25755350/1730545245391-acb4c372-df04-4e45-94dc-b7fc960d2e66.png)
        * 优势: 作为一种优化后的损失函数，能够避免均方误差损失的在处理sigmoid函数时收敛到趋于1时，梯度非常平缓，又因为使用的优化方法往往基于梯度下降，所以出现”学习迟缓”的现象.为了避免该现象，交叉熵的形式应运而生。
...
> 来自: [第三章:特征工程与fasttext模型训练 - Transformer](http://127.0.0.1:5500/%E7%AC%AC%E4%B8%89%E7%AB%A0_%E7%89%B9%E5%BE%81%E5%B7%A5%E7%A8%8B%E4%B8%8Efasttext%E6%A8%A1%E5%9E%8B%E8%AE%AD%E7%BB%83%20-%20Transformer.html)
>
