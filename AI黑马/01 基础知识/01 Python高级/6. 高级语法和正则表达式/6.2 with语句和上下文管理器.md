...
> with语句后面通过`File("1.txt", "r")`创建了File对象,会自动调用File对象的__ener**方法,并把__enter**方法的返回结果赋值给as后的file
>
> 一旦with代码块中的语句执行完成就会自动执行__exit__方法中的代码,即使出现异常也会执行
>
...
> 来自: [with语句和上下文管理器 | Python高级](http://127.0.0.1:5500/regular/with%E4%B8%8A%E4%B8%8B%E6%96%87%E7%AE%A1%E7%90%86%E5%99%A8.html)
>
